 ...
 * @Last Modified time: 2023-11-07 00:36:44
 */
                    ...
                    <div className="relative isolate h-screen px-6 lg:px-8 ">
                        ...
                        >
                            <motion.div
                                ...
                                variants={image}
                            >
                                <div className="-mt-52 flex flex-col justify-center pl-5 lg:mt-0 lg:pl-48">
                                    <motion.div
                                        variants={vote}
                                        className="mb-4 flex items-center"
                                    >
                                        <div className="mr-2 h-1 w-10 bg-yellow-500 md:w-20"></div>
                                        <span className="text-base font-bold text-yellow-500 sm:text-lg md:text-3xl">
                                            VOTE
                                        </span>
                                    </motion.div>
                                    ...
                                    <motion.h1
                                        variants={banner}
                                        className="text-5xl font-bold uppercase tracking-tight text-gray-50 sm:text-6xl md:text-9xl"
                                    >
                                        Dr. Griffith
                                    </motion.h1>
                                    <motion.h1
                                        variants={banner}
                                        className="text-5xl font-bold uppercase tracking-wide text-gray-50 sm:text-6xl md:text-9xl"
                                    >
                                        Selorm
                                    </motion.h1>
                                    <motion.h1
                                        variants={banner}
                                        className="text-5xl font-bold uppercase tracking-wider text-gray-50 sm:text-6xl md:text-9xl"
                                    >
                                        Klogo
                                    </motion.h1>
                                    ...
                                    <motion.h1
                                        variants={banner}
                                        className="mt-6 text-xs font-bold uppercase text-gray-100 md:text-xl"
                                    >
                                    ...
                                    <motion.div
                                        variants={banner}
                                        className="mb-7 flex w-60 items-center md:w-96"
                                    >
                                    ...
                                    >
                                        <button
                                            className="rounded-md bg-slate-50 px-3.5 py-2.5 text-xs font-semibold uppercase text-gray-900 shadow hover:bg-slate-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600"
                                            onClick={() => {
                                                handleButtonClick()
                                                addVotes()
                                            }}
                                        ...
                                        <Link
                                            to="why-me"
                                            className="rounded-md bg-yellow-600 px-3.5 py-2.5 text-xs font-semibold uppercase text-white shadow hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600"
                                        >
                                            Learn more{' '}
